...
import { AlertTriangle, Check, ChevronRight, Download, Loader2, RotateCw, X } from 'lucide-react'
  ...
  return (
    <div className="px-4 py-2.5 border-t border-theme-border">
      ...
      >
        ...
        />
        <span className="text-[10px] uppercase font-bold tracking-widest text-theme-dim">Updates</span>
        {/* Update available badge — visible even when collapsed */}
        {updateState?.updateAvailable && (
          <span className="ml-auto flex items-center gap-1 text-[8px] font-bold uppercase tracking-wider text-theme-success px-1.5 py-0.5 rounded-full border border-[#9ece6a]/30 bg-[#9ece6a]/10">
      ...
      <div
        ...
        style={{
          maxHeight: expanded ? contentRef.current?.scrollHeight ?? 800 : 0,
          opacity: expanded ? 1 : 0,
        }}
      >
        <p className="text-[11px] text-theme-dim mt-2 mb-3 leading-relaxed">
